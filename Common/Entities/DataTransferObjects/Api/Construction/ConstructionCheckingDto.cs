...
{
    public class ConstructionCheckingDto
    {
        public string Id { set; get; } // Id việc kiểm tra
        ...
        public ConstructionCheckingPlanDto ConstructionCheckingPlan { set; get; } // Chi tiết kế hoạch kiểm tra
